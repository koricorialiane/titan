...
- En el distrito financiero la recomendacion es N=4 con tres sectores por sitio.
- En el festival la cobertura no es el problema; la solucion es splitting hasta S4.
